...
public class ItemDAO {
	...
	public Item getItemInfoByItemAndSupplierID(int itemID, int supplierID) throws SQLException {
		String query = "SELECT I.name, SI.price FROM item AS I, item_supplier AS SI WHERE SI.itemID = ? and SI.supplierID = ? and I.itemID = SI.itemID";
		ResultSet result = null;
		PreparedStatement pstatement = null;
		try {
			pstatement = connection.prepareStatement(query);
